...
This specific section is a source for the [plugin.xml](/META-INF/plugin.xml) file which will be extracted by the [Gradle](/build.gradle.kts) during the build process.
